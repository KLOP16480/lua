...
wait(0.4)
SysemKeyyy:Destroy()
getgenv().Key = "MARU-3M5O-KGQX-NUXYH-MN8Z3-11LI"
getgenv().id = "1003611586721763420"
...
function Script()
--Src
print("getgenv().Key = "MARU-3M5O-KGQX-NUXYH-MN8Z3-11LI"
getgenv().id = "1003611586721763420"
loadstring(game:HttpGet(("https://raw.githubusercontent.com/xshiba/MaruBitkub/main/Mobile.lua"), true))()")
end
